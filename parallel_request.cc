...
main (int argc, char *argv[])
{
  ...
  devices1 = pointToPoint.Install (n1);
  ...
  Ipv4InterfaceContainer interfaces1 = address2.Assign (devices1);
  ...
  ApplicationContainer clientApps2 = echoClient2.Install (n1.Get (1));
